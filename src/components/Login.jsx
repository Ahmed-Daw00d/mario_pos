...
export function Login() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      setError(messages[err.code] || 'Si è verificato un errore. Riprova.');
    } finally {
      setLoading(false);
    }
  }
    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-sm space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="opacity-40 text-sm mt-1">Pizza & Kebab — POS System</p>
        </div>
        ...
        <div className="card p-8 space-y-6">
          <div className="text-center">
            ...
            <h2 className="text-xl font-bold text-foreground">Area Riservata</h2>
            <p className="opacity-40 text-sm mt-1">Accesso operatori</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <Mail size={16} className="absolute left-3 top-1/2 -translate-y-1/2 opacity-30" />
                <input
                  type="email"
                  value={email}
        ...
        <p className="text-center text-xs opacity-30">
          POS System — Pizzaria da Mario © 2026
        </p>
      </div>
    </div>
  );
