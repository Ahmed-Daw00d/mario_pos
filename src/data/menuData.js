...
export const BEVANDE = [
  // Water & Soft Drinks
  { id: 'acqua_piccola', name_it: 'Acqua Piccola', name_ar: 'Acqua Piccola', price: 1.00, category: 'water_soft', is_available: true, sort_order: 1 },
  { id: 'acqua_grande_nat', name_it: 'Acqua Grande Naturale', name_ar: 'Acqua Grande Naturale', price: 1.50, category: 'water_soft', is_available: true, sort_order: 2 },
  { id: 'acqua_grande_friz', name_it: 'Acqua Grande Frizzante', name_ar: 'Acqua Grande Frizzante', price: 1.50, category: 'water_soft', is_available: true, sort_order: 3 },
  { id: 'coca_cola_lattina', name_it: 'Coca-Cola Lattina', name_ar: 'Coca-Cola Lattina', price: 1.50, category: 'water_soft', is_available: true, sort_order: 4 },
  { id: 'coca_cola_grande', name_it: 'Coca-Cola Grande', name_ar: 'Coca-Cola Grande', price: 3.00, category: 'water_soft', is_available: true, sort_order: 5 },
  { id: 'fanta_lattina', name_it: 'Fanta Lattina', name_ar: 'Fanta Lattina', price: 1.50, category: 'water_soft', is_available: true, sort_order: 6 },
  { id: 'sprit_lattina', name_it: 'Sprit Lattina', name_ar: 'Sprit Lattina', price: 1.50, category: 'water_soft', is_available: true, sort_order: 7 },
  { id: 'te_freddo_lattina', name_it: 'Te Freddo Lattina', name_ar: 'Te Freddo Lattina', price: 1.00, category: 'water_soft', is_available: true, sort_order: 8 },
  { id: 'energy_drink', name_it: 'Energy Drink', name_ar: 'Energy Drink', price: 2.00, category: 'water_soft', is_available: true, sort_order: 9 },

  // Beer (بيرة)
  { id: 'peroni_piccola', name_it: 'Peroni Piccola', name_ar: 'Peroni Piccola', price: 1.50, category: 'beer', is_available: true, sort_order: 10 },
  { id: 'peroni_grande', name_it: 'Peroni Grande', name_ar: 'Peroni Grande', price: 2.0, category: 'beer', is_available: true, sort_order: 11 },
  { id: 'ichnusa', name_it: 'Ichnusa', name_ar: 'Ichnusa', price: 2.50, category: 'beer', is_available: true, sort_order: 12 },
  { id: 'heineken_piccola', name_it: 'Heineken Piccola', name_ar: 'Heineken Piccola', price: 2.00, category: 'beer', is_available: true, sort_order: 13 },
  { id: 'heineken_grande', name_it: 'Heineken Grande', name_ar: 'Heineken Grande', price: 2.50, category: 'beer', is_available: true, sort_order: 14 },
  { id: 'tennents', name_it: "Tennent's", name_ar: "Tennent's", price: 2.50, category: 'beer', is_available: true, sort_order: 15 },
  { id: 'ceres', name_it: 'Ceres', name_ar: 'Ceres', price: 2.50, category: 'beer', is_available: true, sort_order: 16 },
  { id: 'corona', name_it: 'Corona', name_ar: 'Corona', price: 2.5, category: 'beer', is_available: true, sort_order: 17 },
];
